...
There's a new version of Wifite (*Wifite2*) available at [https://github.com/isolation/wifi](https://github.com/isolation/wifi). *Wifi* has more features, bug fixes, and reliability.
